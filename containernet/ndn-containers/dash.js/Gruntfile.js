module.exports = function (grunt) {
    ...
    //TODO: add back jshint
    grunt.registerTask('default',   ['dist', 'test']);
    grunt.registerTask('dist',      ['clean', 'jscs', 'browserify:mediaplayer' , 'browserify:protection', 'browserify:reporting', 'browserify:all', 'minimize', 'copy:dist']);
