...
var Face = function Face(transportOrSettings, connectionInfo)
{
  ...
  // Event handler
  this.onopen = (settings.onopen || function() { console.log("Face connection established."); });
  this.onclose = (settings.onclose || function() { console.log("Face connection closed."); });
    ...
    this.transport.connect
     (this.connectionInfo, this,
      function() {
        ...
        if (thisFace.onopen)
          console.log('Face.js:reconnectAndExpressInterest calling onopen on success');
          thisFace.onopen();
      },
